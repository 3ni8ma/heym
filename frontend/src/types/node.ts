...
export const NODE_DEFINITIONS: Record<NodeType, NodeDefinition> = {
  ...
  codex: {
    type: "codex",
    label: "Codex",
    description: "Run OpenAI Codex coding tasks in a repository",
    color: "node-codex",
    icon: "Terminal",
    inputs: 1,
    outputs: 1,
  ...
  converter: {
    type: "converter",
    label: "Converter",
    description: "Convert data between formats (CSV and JSON)",
    color: "node-set",
    icon: "Repeat",
    inputs: 1,
    outputs: 1,
  ...
  github: {
    type: "github",
    label: "GitHub",
    description: "Manage repositories, issues, pull requests, and file contents with GitHub REST API",
    color: "node-github",
    icon: "Github",
    inputs: 1,
    outputs: 1,
    defaultData: {
      ...
      githubInviteEmail: "",
      githubIssueNumber: "",
      githubTitle: undefined,
      githubBody: undefined,
      githubCommentBody: "$input.text",
      githubState: undefined,
      githubStateReason: undefined,
      githubAssignee: "",
      githubCreator: "",
      githubMentioned: "",
      githubLabelsFilter: "",
      ...
      githubPrerelease: undefined,
      githubFilePath: "",
      githubFileContent: "$input.text",
      githubCommitMessage: "",
      githubBranch: "",
      githubPerPage: "30",
      githubTagName: "",
      githubReleaseId: "",
      githubWorkflowId: "",
      githubWorkflowInputs: undefined,
  ...
  linear: {
    type: "linear",
    label: "Linear",
    description: "Manage Linear teams, projects, issues, and comments",
    color: "node-linear",
    icon: "ListTodo",
    inputs: 1,
    outputs: 1,
  ...
  jira: {
    type: "jira",
    label: "Jira",
    description: "Manage Jira projects, issues, comments, attachments, users, notifications, and transitions",
    color: "node-jira",
    icon: "ListTodo",
    inputs: 1,
    outputs: 1,
    defaultData: {
      ...
      jiraJql: "updated >= -30d ORDER BY updated DESC",
      jiraFields: "",
      jiraAssigneeAccountId: "",
      jiraLabels: "",
      jiraCommentBody: "$input.text",
      jiraCommentId: "",
      jiraTransitionId: "",
      jiraAttachmentId: "",
  ...
  drive: {
    type: "drive",
    label: "Drive",
    description: "List and manage Drive files: get, delete, password, TTL, max downloads, team share/unshare",
    color: "node-drive",
    icon: "HardDrive",
    inputs: 1,
    outputs: 1,
  ...
  s3: {
    type: "s3",
    label: "Amazon S3",
    description: "Manage buckets and folders; list, upload, download, copy, and delete objects in Amazon S3",
    color: "node-drive",
    icon: "Server",
    inputs: 1,
    outputs: 1,
  ...
  supabase: {
    type: "supabase",
    label: "Supabase",
    description: "Query and mutate Supabase tables through the PostgREST API",
    color: "node-datatable",
    icon: "Database",
    inputs: 1,
    outputs: 1,
    defaultData: {
      label: "supabase",
      credentialId: "",
      supabaseOperation: undefined as string | undefined,
  ...
  notion: {
    type: "notion",
    label: "Notion",
    description: "Manage Notion databases, data sources, pages, and blocks",
    color: "node-notion",
    icon: "FileText",
    inputs: 1,
    outputs: 1,
    defaultData: {
      label: "notion",
      credentialId: "",
      notionOperation: undefined as string | undefined,
      notionQuery: "",
      notionPageId: "",
      notionDatabaseId: "",
      notionDatabase: "{}",
  ...
  sentry: {
    type: "sentry",
    label: "Sentry",
    description: "Manage Sentry organizations, projects, teams, issues, events, and releases",
    color: "node-sentry",
    icon: "ShieldAlert",
    inputs: 1,
    outputs: 1,
