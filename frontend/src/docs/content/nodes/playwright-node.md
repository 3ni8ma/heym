...
| `playwrightCode` | string | Custom Playwright code (alternative to steps). Runs arbitrary backend Python and is **disabled by default** — see the security note below |
