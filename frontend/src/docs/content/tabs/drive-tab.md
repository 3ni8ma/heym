...
The dialog reports how many files it applied to (files you don't own are skipped). Use the rows-per-page selector's **All** option to load every file on one page and select across your whole Drive.
